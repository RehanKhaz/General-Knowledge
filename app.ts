...
console.log(
  chalk.bgYellow.white(
    "Welcome to this Quiz. This quiz will be all about the General Questions regarding Pakistan. This will be so helpful for me as well you for your knowledge. This Quiz will contain 10 questions."
  )
);
...
if (i === 0) {
  console.log(
    `Unfortunately ${userAnswer.Name}! your all answers are incorrect. You should get some basic knowledge about Pakistan.`
  );
} 
 else if (i === 1) {
  console.log(
    chalk.blue.bgWhiteBright(`${userAnswer.Name}! your ${i} answer is correct.`)
  );
} 
 else if (i > 1 && i < 10) {
  console.log(
    chalk.blue.bgWhiteBright(
      `${userAnswer.Name}! your ${i} answers are correct.`
    )
  );
}
 else if (i === 10) {
  console.log(
    `Fantastic ${userAnswer.Name}! your all answers are correct. You know a lot about Pakistan.`
  );
}
